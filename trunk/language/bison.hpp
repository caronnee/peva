...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     TOKEN_BEGIN = 282,
     TOKEN_END = 283,
     TOKEN_OBJECT_FEATURE = 284,
     TOKEN_IDENTIFIER = 285,
     TOKEN_UINT = 286,
     TOKEN_REAL = 287,
     TOKEN_VISIT = 288,
     TOKEN_VISIT_SEQUENCE = 289,
     TOKEN_KILLED = 290,
     TOKEN_START = 291,
     TOKEN_OPER_REL = 292,
     TOKEN_OPER_SIGNADD = 293,
     TOKEN_OPER_MUL = 294,
     TOKEN_PLUSPLUS = 295,
     TOKEN_MINUSMINUS = 296,
     TOKEN_BOOL_AND = 297,
     TOKEN_BOOL_OR = 298
   };
#endif
...
#define TOKEN_ROBOT 272
#define TOKEN_OPTION 273
...
#define TOKEN_OBJECT_FEATURE 284
#define TOKEN_IDENTIFIER 285
#define TOKEN_UINT 286
#define TOKEN_REAL 287
#define TOKEN_VISIT 288
#define TOKEN_VISIT_SEQUENCE 289
#define TOKEN_KILLED 290
#define TOKEN_START 291
#define TOKEN_OPER_REL 292
#define TOKEN_OPER_SIGNADD 293
#define TOKEN_OPER_MUL 294
#define TOKEN_PLUSPLUS 295
#define TOKEN_MINUSMINUS 296
#define TOKEN_BOOL_AND 297
#define TOKEN_BOOL_OR 298
