#include "steny.h"
const SDL_Surface* fading=IMG_Load("./images/Fade.png");
const SDL_Surface* changing=IMG_Load("./images/Change.png");
const SDL_Surface* moving=IMG_Load("./images/Fade.png");//potom zmenit
const SDL_Surface* solid=IMG_Load("./images/Solid.png");
const SDL_Surface* nothing=IMG_Load("./images/Nic.png");
