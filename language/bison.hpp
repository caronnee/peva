...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     TOKEN_REAL = 287,
     TOKEN_OPER_REL = 288,
     TOKEN_OPER_SIGNADD = 289,
     TOKEN_OPER_MUL = 290,
     TOKEN_PLUSPLUS = 291,
     TOKEN_MINUSMINUS = 292,
     TOKEN_BOOL_AND = 293,
     TOKEN_BOOL_OR = 294
   };
#endif
...
#define TOKEN_OPER_REL 288
#define TOKEN_OPER_SIGNADD 289
#define TOKEN_OPER_MUL 290
#define TOKEN_PLUSPLUS 291
#define TOKEN_MINUSMINUS 292
#define TOKEN_BOOL_AND 293
#define TOKEN_BOOL_OR 294
